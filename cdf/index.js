		...
		context[ 'parameterChecks' ] = this.parameters.map( function( p ) {
			...
			switch ( p.domain ) {
				case 'Real numbers':
					...
					s += '\t\t\treturn new TypeError( \'cdf()::invalid option. `' + p.name + '` parameter must be a number primitive. ';
				...
				case 'Positive real numbers':
					...
					s += '\t\t\treturn new TypeError( \'cdf()::invalid option. `' + p.name + '` parameter must be a positive number. ';
					s += 'Option: `\' + opts.' + p.name + ' + \'`.\' );\n';
					s += '\t\t}\n';
					s += '\t}';
				...
				case 'Non-negative real numbers':
					...
					s += '\t\t\treturn new TypeError( \'cdf()::invalid option. `' + p.name + '` parameter must be a non-negative number. ';
					s += 'Option: `\' + opts.' + p.name + ' + \'`.\' );\n';
					s += '\t\t}\n';
					s += '\t}';
				...
				case 'Non-negative integers':
					...
					s += '\t\t\treturn new TypeError( \'cdf()::invalid option. `' + p.name + '` parameter must be a non-negative integer. ';
					s += 'Option: `\' + opts.' + p.name + ' + \'`.\' );\n';
					s += '\t\t}\n';
					s += '\t}';
